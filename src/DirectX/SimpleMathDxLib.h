//-------------------------------------------------------------------------------------
// SimpleMathDxLib.h -- Simplified C++ Math wrapper for DirectXMath (For DxLib)
//
...
// OCA Modified For DxLib.

#ifndef DX_LIB_H
	#error include "DxLib.h" を SimpleMathDxLib.hの前に入れてください
#endif
...
namespace DxLib
{
	...
	struct Rectangle
	{
		...
		{
			return Windows::Foundation::Rect( float( x ),
											  float( y ),
											  float( width ),
											  float( height ) );
		}
		...
		// Static functions
		static Rectangle Intersect( const Rectangle& ra,
									const Rectangle& rb ) noexcept;
		static RECT Intersect( const RECT& rcta, const RECT& rctb ) noexcept;

		static Rectangle Union( const Rectangle& ra,
								const Rectangle& rb ) noexcept;
	...
	struct Vector2 : public DirectX::XMFLOAT2
	{
		...
		Vector2( const DxLib::VECTOR& v )
		{
			x = v.x;
			y = v.y;
		}
		Vector2& operator=( const DxLib::VECTOR& v )
		{
			x = v.x;
			y = v.y;
			return *this;
		}
		Vector2( const DxLib::FLOAT2& v )
		{
			x = v.u;
			y = v.v;
		}
		Vector2& operator=( const DxLib::FLOAT2& v )
		{
			x = v.u;
			y = v.v;
			return *this;
		}
		operator const DxLib::FLOAT2&()
		{
			return *( reinterpret_cast<const DxLib::FLOAT2*>( this ) );
		}
		...
		static void	   SmoothStep( const Vector2& v1,
								   const Vector2& v2,
								   float		  t,
								   Vector2&		  result ) noexcept;
		static Vector2 SmoothStep( const Vector2& v1,
								   const Vector2& v2,
								   float		  t ) noexcept;
		...
		static void	   Barycentric( const Vector2& v1,
									...
									float		   g,
									Vector2&	   result ) noexcept;
		static Vector2 Barycentric( const Vector2& v1,
									const Vector2& v2,
									const Vector2& v3,
									float		   f,
									float		   g ) noexcept;
		...
		static void	   CatmullRom( const Vector2& v1,
								   ...
								   float		  t,
								   Vector2&		  result ) noexcept;
		static Vector2 CatmullRom( const Vector2& v1,
								   const Vector2& v2,
								   const Vector2& v3,
								   const Vector2& v4,
								   float		  t ) noexcept;
		...
		static void	   Hermite( const Vector2& v1,
								...
								float		   t,
								Vector2&	   result ) noexcept;
		static Vector2 Hermite( const Vector2& v1,
								const Vector2& t1,
								const Vector2& v2,
								const Vector2& t2,
								float		   t ) noexcept;

		static void	   Reflect( const Vector2& ivec,
								const Vector2& nvec,
								Vector2&	   result ) noexcept;
		static Vector2 Reflect( const Vector2& ivec,
								const Vector2& nvec ) noexcept;

		static void	   Refract( const Vector2& ivec,
								const Vector2& nvec,
								float		   refractionIndex,
								Vector2&	   result ) noexcept;
		static Vector2 Refract( const Vector2& ivec,
								const Vector2& nvec,
								float		   refractionIndex ) noexcept;

		static void	   Transform( const Vector2&	v,
								  const Quaternion& quat,
								  Vector2&			result ) noexcept;
		static Vector2 Transform( const Vector2&	v,
		...
		static void	   TransformNormal( const Vector2& v,
										const Matrix&  m,
										Vector2&	   result ) noexcept;
		static Vector2 TransformNormal( const Vector2& v,
	...
	struct Vector3 : public DirectX::XMFLOAT3
	{
		...
		Vector3( const DxLib::VECTOR& v )
		{
			x = v.x;
			y = v.y;
			z = v.z;
		}
		Vector3& operator=( const DxLib::VECTOR& v )
		{
			x = v.x;
			y = v.y;
			z = v.z;
		...
		operator const DxLib::VECTOR&()
		{
			return *( reinterpret_cast<const DxLib::VECTOR*>( this ) );
		}
		...
		static void	   SmoothStep( const Vector3& v1,
								   const Vector3& v2,
								   float		  t,
								   Vector3&		  result ) noexcept;
		static Vector3 SmoothStep( const Vector3& v1,
								   const Vector3& v2,
								   float		  t ) noexcept;
		...
		static void	   Barycentric( const Vector3& v1,
									...
									float		   g,
									Vector3&	   result ) noexcept;
		static Vector3 Barycentric( const Vector3& v1,
									const Vector3& v2,
									const Vector3& v3,
									float		   f,
									float		   g ) noexcept;
		...
		static void	   CatmullRom( const Vector3& v1,
								   ...
								   float		  t,
								   Vector3&		  result ) noexcept;
		static Vector3 CatmullRom( const Vector3& v1,
								   const Vector3& v2,
								   const Vector3& v3,
								   const Vector3& v4,
								   float		  t ) noexcept;
		...
		static void	   Hermite( const Vector3& v1,
								...
								float		   t,
								Vector3&	   result ) noexcept;
		static Vector3 Hermite( const Vector3& v1,
								const Vector3& t1,
								const Vector3& v2,
								const Vector3& t2,
								float		   t ) noexcept;

		static void	   Reflect( const Vector3& ivec,
								const Vector3& nvec,
								Vector3&	   result ) noexcept;
		static Vector3 Reflect( const Vector3& ivec,
								const Vector3& nvec ) noexcept;

		static void	   Refract( const Vector3& ivec,
								const Vector3& nvec,
								float		   refractionIndex,
								Vector3&	   result ) noexcept;
		static Vector3 Refract( const Vector3& ivec,
								const Vector3& nvec,
								float		   refractionIndex ) noexcept;

		static void	   Transform( const Vector3&	v,
								  const Quaternion& quat,
								  Vector3&			result ) noexcept;
		...
		static void	   TransformNormal( const Vector3& v,
										const Matrix&  m,
										Vector3&	   result ) noexcept;
		static Vector3 TransformNormal( const Vector3& v,
										const Matrix&  m ) noexcept;
	...
	struct Vector4 : public DirectX::XMFLOAT4
	{
		...
		Vector4& operator=( const DxLib::VECTOR& v )
		{
			x = v.x;
			y = v.y;
			z = v.z;
		...
		Vector4& operator=( const DxLib::FLOAT4& v )
		{
			x = v.x;
			y = v.y;
			z = v.z;
		...
		operator const DxLib::FLOAT4&()
		{
			return *( reinterpret_cast<const DxLib::FLOAT4*>( this ) );
		}
		...
		void Clamp( const Vector4& vmin,
					const Vector4& vmax,
					Vector4&	   result ) const noexcept;

		// Static functions
		static float Distance( const Vector4& v1, const Vector4& v2 ) noexcept;
		static float DistanceSquared( const Vector4& v1,
									  const Vector4& v2 ) noexcept;

		static void	   Min( const Vector4& v1,
							const Vector4& v2,
							Vector4&	   result ) noexcept;
		static Vector4 Min( const Vector4& v1, const Vector4& v2 ) noexcept;

		static void	   Max( const Vector4& v1,
							const Vector4& v2,
							Vector4&	   result ) noexcept;
		static Vector4 Max( const Vector4& v1, const Vector4& v2 ) noexcept;

		static void	   Lerp( const Vector4& v1,
							 const Vector4& v2,
							 float			t,
							 Vector4&		result ) noexcept;
		...
		static void	   SmoothStep( const Vector4& v1,
								   const Vector4& v2,
								   float		  t,
								   Vector4&		  result ) noexcept;
		static Vector4 SmoothStep( const Vector4& v1,
								   const Vector4& v2,
								   float		  t ) noexcept;
		...
		static void	   Barycentric( const Vector4& v1,
									...
									float		   g,
									Vector4&	   result ) noexcept;
		static Vector4 Barycentric( const Vector4& v1,
									const Vector4& v2,
									const Vector4& v3,
									float		   f,
									float		   g ) noexcept;
		...
		static void	   CatmullRom( const Vector4& v1,
								   ...
								   float		  t,
								   Vector4&		  result ) noexcept;
		static Vector4 CatmullRom( const Vector4& v1,
								   const Vector4& v2,
								   const Vector4& v3,
								   const Vector4& v4,
								   float		  t ) noexcept;
		...
		static void	   Hermite( const Vector4& v1,
								...
								float		   t,
								Vector4&	   result ) noexcept;
		static Vector4 Hermite( const Vector4& v1,
								const Vector4& t1,
								const Vector4& v2,
								const Vector4& t2,
								float		   t ) noexcept;

		static void	   Reflect( const Vector4& ivec,
								const Vector4& nvec,
								Vector4&	   result ) noexcept;
		static Vector4 Reflect( const Vector4& ivec,
								const Vector4& nvec ) noexcept;

		static void	   Refract( const Vector4& ivec,
								const Vector4& nvec,
								float		   refractionIndex,
								Vector4&	   result ) noexcept;
		static Vector4 Refract( const Vector4& ivec,
								const Vector4& nvec,
								float		   refractionIndex ) noexcept;
		...
		static void	   Transform( const Vector2&	v,
								  const Quaternion& quat,
								  Vector4&			result ) noexcept;
		static Vector4 Transform( const Vector2&	v,
								  const Quaternion& quat ) noexcept;

		static void	   Transform( const Vector3&	v,
								  const Quaternion& quat,
								  Vector4&			result ) noexcept;
		static Vector4 Transform( const Vector3&	v,
								  const Quaternion& quat ) noexcept;

		static void	   Transform( const Vector4&	v,
								  const Quaternion& quat,
								  Vector4&			result ) noexcept;
		static Vector4 Transform( const Vector4&	v,
								  const Quaternion& quat ) noexcept;
	...
	struct Matrix : public DirectX::XMFLOAT4X4
	{
		...
		constexpr Matrix( float m00,
			...
			: DirectX::XMFLOAT4X4( m00,
						  ...
						  m33 )
		{}
		explicit Matrix( const Vector3& r0,
						 const Vector3& r1,
						 const Vector3& r2 ) noexcept
			: DirectX::XMFLOAT4X4( r0.x,
						  r0.y,
						  r0.z,
						  0,
						  r1.x,
						  ...
						  1.f )
		{}
		explicit Matrix( const Vector4& r0,
						 const Vector4& r1,
						 const Vector4& r2,
		...
		operator const DxLib::MATRIX&()
		{
			return *( reinterpret_cast<const DxLib::MATRIX*>( this ) );
		}
		...
		static Matrix CreateFromAxisAngle( const Vector3& axis,
		...
		static Matrix CreatePerspective( float width,
										 float height,
										 float nearPlane,
										 float farPlane ) noexcept;
		static Matrix CreatePerspectiveOffCenter( float left,
												  ...
												  float nearPlane,
												  float farPlane ) noexcept;
		static Matrix CreateOrthographic( float width,
										  float height,
										  float zNearPlane,
		...
		static Matrix CreateFromYawPitchRoll( float yaw,
											  float pitch,
											  float roll ) noexcept;

		static Matrix CreateShadow( const Vector3& lightDir,
									const Plane&   plane ) noexcept;

		static Matrix CreateReflection( const Plane& plane ) noexcept;

		static void	  Lerp( const Matrix& M1,
							const Matrix& M2,
							float		  t,
							Matrix&		  result ) noexcept;
		static Matrix Lerp( const Matrix& M1,
							const Matrix& M2,
							float		  t ) noexcept;

		static void	  Transform( const Matrix&	   M,
								 const Quaternion& rotation,
								 Matrix&		   result ) noexcept;
		static Matrix Transform( const Matrix&	   M,
	...
	struct Plane : public DirectX::XMFLOAT4
	{
		...
		static void	 Transform( const Plane&	  plane,
								const Quaternion& rotation,
								Plane&			  result ) noexcept;
		static Plane Transform( const Plane&	  plane,
								const Quaternion& rotation ) noexcept;
	...
	struct Quaternion : public DirectX::XMFLOAT4
	{
		...
		// Static functions
		static Quaternion CreateFromAxisAngle( const Vector3& axis,
											   float		  angle ) noexcept;
		...
		static void		  Concatenate( const Quaternion& q1,
									   const Quaternion& q2,
									   Quaternion&		 result ) noexcept;
		static Quaternion Concatenate( const Quaternion& q1,
	...
	public:
		...
		// Ray operations
		bool Intersects( const DirectX::BoundingSphere& sphere,
						 _Out_ float&		   Dist ) const noexcept;
		bool Intersects( const DirectX::BoundingBox& box,
						 _Out_ float&		Dist ) const noexcept;
		bool Intersects( const Vector3& tri0,
						 const Vector3& tri1,
						 const Vector3& tri2,
						 _Out_ float&	Dist ) const noexcept;
	...
	defined( __XBOX_D3D12_X__ )
		...
		Vector3 Unproject( const Vector3& p,
						   const Matrix&  proj,
						   const Matrix&  view,
						   const Matrix&  world ) const noexcept;
		...
		// Static methods
		static RECT __cdecl ComputeDisplayArea( DXGI_SCALING scaling,
...
namespace std
{
	...
	template <> struct less<DxLib::Rectangle>
	{
		bool operator()(
			const DxLib::Rectangle& r1,
						 const DxLib::Rectangle& r2 ) const noexcept
		{
			return (
	...
	template <> struct less<DxLib::Vector2>
	{
		bool operator()( const DxLib::Vector2& V1,
						 const DxLib::Vector2& V2 ) const noexcept
		{
			return ( ( V1.x < V2.x ) ||
					 ( ( V1.x == V2.x ) && ( V1.y < V2.y ) ) );
		}
	...
	template <> struct less<DxLib::Vector3>
	{
		bool operator()( const DxLib::Vector3& V1,
						 const DxLib::Vector3& V2 ) const noexcept
		{
			return (
				( V1.x < V2.x ) || ( ( V1.x == V2.x ) && ( V1.y < V2.y ) ) ||
				( ( V1.x == V2.x ) && ( V1.y == V2.y ) && ( V1.z < V2.z ) ) );
		}
	};

	template <> struct less<DxLib::Vector4>
	{
		bool operator()( const DxLib::Vector4& V1,
						 const DxLib::Vector4& V2 ) const noexcept
		{
			return (
				( V1.x < V2.x ) || ( ( V1.x == V2.x ) && ( V1.y < V2.y ) ) ||
				( ( V1.x == V2.x ) && ( V1.y == V2.y ) && ( V1.z < V2.z ) ) ||
	...
	template <> struct less<DxLib::Matrix>
	{
		bool operator()( const DxLib::Matrix& M1,
						 const DxLib::Matrix& M2 ) const noexcept
		{
			if ( M1._11 != M2._11 )
	...
	template <> struct less<DxLib::Plane>
	{
		bool operator()( const DxLib::Plane& P1,
						 const DxLib::Plane& P2 ) const noexcept
		{
			return (
	...
	template <> struct less<DxLib::Quaternion>
	{
		bool operator()(
			const DxLib::Quaternion& Q1,
			const DxLib::Quaternion& Q2 ) const noexcept
		{
			return (
				( Q1.x < Q2.x ) || ( ( Q1.x == Q2.x ) && ( Q1.y < Q2.y ) ) ||
	...
	template <> struct less<DxLib::Color>
	{
		bool operator()( const DxLib::Color& C1,
						 const DxLib::Color& C2 ) const noexcept
		{
			return (
				( C1.x < C2.x ) || ( ( C1.x == C2.x ) && ( C1.y < C2.y ) ) ||
	...
	template <> struct less<DxLib::Ray>
	{
		bool operator()( const DxLib::Ray& R1,
						 const DxLib::Ray& R2 ) const noexcept
		{
	...
	template <> struct less<DxLib::Viewport>
	{
		bool operator()(
			const DxLib::Viewport& vp1,
			const DxLib::Viewport& vp2 ) const noexcept
		{
			if ( vp1.x != vp2.x )
				return ( vp1.x < vp2.x );
			if ( vp1.y != vp2.y )
